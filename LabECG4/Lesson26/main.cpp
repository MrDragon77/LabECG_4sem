...
public:
    ...
    bool Init()
    {
        ...
        m_pTexture = new Texture(GL_TEXTURE_2D, "bricks.png");
        ...
        m_pNormalMap = new Texture(GL_TEXTURE_2D, "normal_map.png");
        
        if (!m_pNormalMap->Load()) {
            return false;
        }

        m_pTrivialNormalMap = new Texture(GL_TEXTURE_2D, "normal_up.png");
