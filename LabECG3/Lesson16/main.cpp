...
static void RenderSceneCB()
{
    ...
    Matrix4f Projection;
    Projection.InitPersProjTransform(FOV, (float)WINDOW_WIDTH, (float)WINDOW_HEIGHT, zNear, zFar);
...
int main(int argc, char** argv)
{
    ...
    // snprintf(game_mode_string, sizeof(game_mode_string), "%dx%d@59", WINDOW_WIDTH, WINDOW_HEIGHT);
    ...
    pTexture = new Texture(GL_TEXTURE_2D, "bricks2.png");
